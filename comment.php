...
<body>
    <div class="row">
        ...
        <div class="col-md-8 text-center">
            ...
            <!--    <input type="hidden" name="no" no="no" value="">-->
                <table id="edit" class="table table-striped table-bordered">
                  ...
                  <td></td>
                            <td class="text-center">
                                <textarea id="content" name="content" style="resize:none;height: 100px" class="area" placeholder="發表評論..."></textarea>
                            </td>
                            <td></td>
                            <td>
            ...
            <table id="ex" name="ex" class="table table-striped table-bordered">
                <thead>
                    <tr>
                        <th class="text-center">帳號</th>
                        <th class="text-center">內容</th>
